...
- `cd frank && python3 -m pytest` — Frank rule engine + enforcement tests, plus
  the sorting/sifting (`triage.py`) and Overseer (`overseer.py`) tests added
  this session (69 tests total).
